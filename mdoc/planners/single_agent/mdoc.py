...
class MDOC(SingleAgentPlanner):
    ...
    def __init__(
        ...
        run_prior_only, run_prior_then_guidance = False, False
        if planner_alg == 'mdoc':
            pass
        ...
        print(f'start_state_pos: {start_state_pos}, goal_state_pos: {goal_state_pos}')
    ...
    def __call__(self, start_state_pos, goal_state_pos, constraints_l=None, experience: PathBatchExperience = None, *args, **kwargs) -> PlannerOutput:
        """
            ...
            param experience: The previous path of the robot. This would be used to guide the next path.
        """
        ...
        with TimerCUDA() as timer_inference:
            if experience is None:
                trajs_normalized_iters, _, _ = self.run_constrained_inference(cost_constraints_l)  # Shape [B (n_samples), H, D]

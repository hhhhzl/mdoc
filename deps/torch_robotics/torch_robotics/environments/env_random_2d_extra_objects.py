...
from torch_robotics.environments.env_random_dense_2d import EnvRandomDense2D
...
class EnvRandom2DExtraObjects(EnvRandom2DFixed):
    def __init__(self, tensor_args=None, **kwargs):
        ...
        super().__init__(
            ...
            obj_extra_list=[ObjectField(obj_extra_list, 'random2d-extraobjects')],
            tensor_args=tensor_args,
            **kwargs
        )


class EnvRandomDense2DExtraObjects(EnvRandomDense2D):
    def __init__(self, tensor_args=None, **kwargs):
        obj_extra_list = [
            MultiSphereField(
                # np.array([[0.5, 0.5]]),  # (n, 2) array of sphere centers.
        ...
        super().__init__(
            name=self.__class__.__name__,
            obj_extra_list=[ObjectField(obj_extra_list, 'randomdense2d-extraobjects')],
            tensor_args=tensor_args,
            **kwargs
        )
...
class EnvRandomLarge2DExtraObjects(EnvRandomLarge2D):
    def __init__(self, tensor_args=None, **kwargs):
        ...
        super().__init__(
            name=self.__class__.__name__,
            obj_extra_list=[ObjectField(obj_extra_list, 'randomlarge2d-extraobjects')],
            tensor_args=tensor_args,
            **kwargs
        )

class EnvRandomExtraLarge2DExtraObjects(EnvRandomExtraLarge2D):
    def __init__(self, tensor_args=None, **kwargs):
        obj_extra_list = [
            MultiSphereField(
                # np.array([[0.5, 0.5]]),  # (n, 2) array of sphere centers.
        ...
        super().__init__(
            name=self.__class__.__name__,
            obj_extra_list=[ObjectField(obj_extra_list, 'randomextralarge2d-extraobjects')],
            tensor_args=tensor_args,
            **kwargs
        )

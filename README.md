...
The dataset for reproducing **MMD-CBS** baselines is available on [Google Drive](https://drive.google.com/file/d/10DiuwkccMDNBFkTMfXRTj7f8gO1TCah_/view?usp=sharing). Please refer to the upstream [MMD repository](https://github.com/yoraish/mmd) for model-free pretraining and more details. All experimental results could be found under [`assets`](assets).
